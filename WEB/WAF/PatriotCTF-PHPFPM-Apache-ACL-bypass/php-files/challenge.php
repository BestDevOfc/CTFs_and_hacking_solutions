SOLUTION to bypass ACL:
    /challenge.php%3FRANDOM.php
    1) /challenge.php%3FRANDOM.php != <Files "challenge.php">
    2) 
    PHP FPM does this in the background:
    - URL decode
    - remove everything after ?
    - now becomes: /challenge.php
    - source: https://book.hacktricks.xyz/network-services-pentesting/pentesting-web/apache
...
echo "will this be empty? --> " . $countryList[$input];
